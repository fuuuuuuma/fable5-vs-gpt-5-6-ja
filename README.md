...
4. [ベンチマークで殴り合う — 数字はどう分かれたか](#4-ベンチマークで殴り合う--数字はどう分かれたか)
5. [コスパで殴り合う — 「同じ賢さをいくらで」](#5-コスパで殴り合う--同じ賢さをいくらで)
6. [スピードで殴り合う — 速さは「トークンの少なさ」で決まる](#6-スピードで殴り合う--速さはトークンの少なさで決まる)
7. [設計思想の違い — 「未知を見つける」対「野心に合わせて広がる」](#7-設計思想の違い--未知を見つける対野心に合わせて広がる)
8. [effort（本気度）— もう1つの隠れたレバー](#8-effort本気度--もう1つの隠れたレバー)
9. [実際の出力を並べてみる（5分野・再現イメージ）](#9-実際の出力を並べてみる5分野再現イメージ)
10. [結論 — どっちが優秀か、はっきり決める](#10-結論--どっちが優秀かはっきり決める)
11. [使い方（初心者基準）— 両方に投げて見比べる](#11-使い方初心者基準--両方に投げて見比べる)
12. [もう一歩 — API・使い分け運用の勘所](#12-もう一歩--api使い分け運用の勘所)
13. [よくある質問（FAQ）](#13-よくある質問faq)
14. [プレゼントキットの中身と受け取り方](#14-プレゼントキットの中身と受け取り方)
15. [出典・一発リンク集](#15-出典一発リンク集)
...
## 7. 設計思想の違い — 「未知を見つける」対「野心に合わせて広がる」
...
## 9. 実際の出力を並べてみる（5分野・再現イメージ）

数字だけだと伝わりにくいので、**同じ依頼を両方に投げたときの出力の“らしさ”**を、分野を変えて5つ並べます。以下は実際の応答傾向をもとにした再現イメージで、内容は説明用に整えたものです（実際の出力は毎回変わります）。スライド版・1枚資料版では、この見比べを**実際のアプリ画面風のUI**で左右に並べて見られます。

共通して出るクセはこうです。**Claude（Fable 5）は「作る前に、あなたが決めきれていないこと（未知）を確認しにくる」**——質問と「よくある失敗・注意点」を自分から添えます。精度は高いぶん、ひと手間かかります。**ChatGPT（GPT-5.6）は「とりあえず形になる完成品を、速く、そのまま渡してくる」**——次の一手（画像生成・表・案の増量）まで提案して、勢いよく前に進めます。分野を変えても、この性格は一貫しています。

**① 文章：料理教室のLP構成案を作って**
- Fable 5 →「作る前に3つ確認させてください（ゴール／客層／強み）」と前提を詰め、「教室の“特徴”から書き始めるのはよくある失敗」と盲点を指摘。
- GPT-5.6 →「①ヒーロー＋予約ボタン ②悩み共感…⑦FAQ→再予約」と7ブロックを即提示し、「このまま画像も10枚作りますか？」と次を提案。

**② 調べ物：新NISAをやさしく教えて**
- Fable 5 →「目的は“制度を理解”か“始め方”か」を確認し、「“必ず得”という話には注意（元本割れの可能性は残る）」と釘を刺す。
- GPT-5.6 →「税金がかからない／年間の枠／少額から自動積立…」と要点を速く整理し、「注意点も5行で出しますか？」。

**③ アイデア出し：カフェのキャッチコピー**
- Fable 5 →「“誰に何を約束するか”で決まる。客層は？」と方向性を先に固めてから3案。
- GPT-5.6 →その場で10案をずらりと出し、「刺さるものを教えてくれれば、そのトーンで20案に増やします」。

**④ 学び直し：複利を中学生にも分かるように**
- Fable 5 →「“計算式まで”か“イメージだけ”か」を聞き、雪だるまの比喩＋最後に理解確認クイズ。
- GPT-5.6 →「増えた分にも利息がつくしくみ」＋具体例（100円→110円→121円…）を即提示し、「図にもできますが要りますか？」。

**⑤ 段取り：引っ越しやることリスト**
- Fable 5 →「何週間後？ 単身か家族か」で手続き量を確認し、「忘れがちな住所変更は別枠で出します」。
- GPT-5.6 →【3週前】【2週前】…と時系列で即リスト化し、「印刷用に表でも出せます」。

**どちらが“良い”かは場面次第**です。じっくり練りたい企画の入り口なら Fable 5 の問いかけが効くし、今すぐたたき台が欲しいなら GPT-5.6 の速さが効く。**同じ依頼を両方に投げて、この違いを自分の目で見比べる**のが、相棒選びのいちばんの近道です（そのための比較用プロンプトを100本、後半のプレゼントにまとめました）。

---

## 10. 結論 — どっちが優秀か、はっきり決める
